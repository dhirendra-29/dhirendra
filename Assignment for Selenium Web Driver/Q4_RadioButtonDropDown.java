...
public class Q4_RadioButtonDropDown {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("Dhirendrasinh");

        driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("Chavda");

        driver.findElement(By.xpath("//textarea[@ng-model='Adress']")).sendKeys("Gandhinagar");

        driver.findElement(By.xpath("//input[@type='email']")).sendKeys("dhirendrachavda2004@example.com");

        driver.findElement(By.xpath("//input[@type='tel']")).sendKeys("8153854671");
        ...
        driver.findElement(By.id("daybox")).sendKeys("15");
